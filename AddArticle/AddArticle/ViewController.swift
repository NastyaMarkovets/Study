...
class ViewController: UIViewController, UITextFieldDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    @IBAction func save(_ sender: AnyObject) {
        UIImageWriteToSavedPhotosAlbum(addPhoto.image!, self, #selector(image(_:didFinishSavingWithError:contextInfo:)), nil)
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        addPhoto.image = info[UIImagePickerControllerOriginalImage] as? UIImage //добавление выбранной картинки в imageView
    }
